...
date_default_timezone_set("Asia/Kolkata");
            ...
            $r=mysqli_query($conn,"select  * from user where userId='$refer'");
            ...
            if(!empty($_POST))
            {
              ...
              $sql=mysqli_query($conn,"UPDATE `user` SET `email`='$email1',`pasword`='$password1' WHERE userId='$uid'");
              if($sql==true)
              {
                $status=1;
                $h=mysqli_query($conn,"select  * from user where userId='$uid'");
...
<svg >
  ...
  Profile
      ...
      <div class="wrapper" style="margin-top:30px;"><center>
    <div class="img-area">
      <div class="inner-area">
        <img src="../admin/uploads/<?php echo $uid.".png"; ?>" alt="">
      </div>
    </div>
</center>
    <div class="icon arrow"><i class="fas fa-arrow-left"></i></div>
    <div class="icon dots"><i class="fas fa-ellipsis-v"></i></div>
    <div class="name"><?php echo "UserId : ".$uid; ?></div>
    <div class="about"><?php echo "ReferId : ".$refer; ?></div>
    <div class="about"><?php echo "Level : ".$level; ?></div>
    <div class="about"><?php echo "Joining Date: ".$date; ?></div>
    <div class="about"><?php echo "Name : ".$uname; ?></div>
    <div class="about"><?php echo "Adhar: ".$adhar; ?></div>

    <div class="about"><?php echo "Phone : ".$phone; ?></div>
    ...
    <div class="social-share">
	  ...
	  <span class="text">
						<h3> <?php
						 ...
						 echo "<i class=\"fas fa-rupee-sign\"></i> ".$earn; ?> </h3>
						 </span>
        <i class="fas fa-rupee-sign"></i>    <span>Earning</span>
		</Center>
      </div>
      <div class="row">
            ...
            <center>
					...
					if(empty($totalPosts)){
						$totalPosts=0;
						 ...
						 echo "".$totalPosts; ?> </h3> <i class="fas fa-user-plus"></i> <span>
						Members</span>
   ...
   team($uid,$conn);
       echo "".$count1; ?> 
      </h3> <i class="fas fa-users"></i> <span>
     Team</span>
...
<br><br>
  ...
  <span class="text"  style="background:#ffff;">
     ...
     <div class="data"  style="background:#ffff;">
              <label>User ID</label>
              <input type="text" name="title" required readonly value=<?php echo "".$uid; ?>>
           </div>
    <!--        <div class="data"  style="background:#ffff;">
              <label>Adhar ID</label>
              <input type="text" name="title" required readonly value=<?php echo "".$adhar; ?>>
           </div>  
           <div class="data">
              <label>Level</label>
              <input type="text" name="userName" required readonly value="<?php echo "".$level ?>">
           </div>
     <div class="data">
              <label>User Name</label>
              <input type="text" name="userName" required readonly value="<?php echo "".$uname ?>">
           </div>
           <div class="data">
              <label>Phone</label>
              <input type="text" name="phone" required readonly value=<?php echo "".$phone; ?>>
           </div> -->
           <div class="data">
              <label>Email</label>
     ...
     <!--       <div class="data">
              <label>Pincode</label>
              <input type="text" name="pincode" required readonly value=<?php echo "".$pincode; ?>>
           </div>  -->
           <div class="data">
